...
inside Markdown files. The blog you're reading right now [uses this](https://github.com/leerob/michaelangelo.io).
...
Feel free to [reach out](mailto:me@michaelangelo.io) if you wanna chat about building design systems.
